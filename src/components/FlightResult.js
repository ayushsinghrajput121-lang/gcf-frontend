...
useEffect(() => {
  ...
  if (apiData && apiData.data && apiData.data.length > 0) {
    ...
    // Check selectedDataIndex and navigate to flightSubmit
    if (
      ...
      navigate("/flightSubmit", {
        state: {
          ...
          tripType: location.state?.tripType || null,
        },
      });
    }
  }
}, [apiData, selectedDataIndex, displayedData, navigate, location.state]);
...
useEffect(() => {
 ...
 const toggleItem = async (offer, index) => {
  ...
  const dateStringD= location.state.details.from;
  const dateStringA = location.state.details.to;
          ...
          <div className="data-display">
            {displayedData.map((segment, index) => (
              <div key={index}>
                ...
                {/* Departure Time filter code below */}
                {/* <div className="left_side_search_boxed">
                  <div className="left_side_search_heading">
                ...
                {/* Arrival Time filter code below */}
                {/* <div className="left_side_search_boxed">
                  <div className="left_side_search_heading">
                              ...
                              <div className="form-check filter-b-side-s col-md" key={index}>
                                ...
                                >
                                  ...
                                  <label
                                    ...
                                    // htmlFor={`flexCheckDefaults${index + 1}`}
                                  >
                                    <span className="area_flex_one-ft">
                                      <span>
                      ...
                      >
                        ...
                        <div className="col-md-3 text-center">
                          <div className="wrap-amout">
                            ...
                            <div>
                              {/* {excelData.map((data, index) => { const flightclass = offer.travelerPricings[0].fareDetailsBySegment[0].class;
                                return (
                                  <div key={index}>
                                    <ul
                                      style={{
                        ...
                        <div className="col-md-12">
                          ...
                          >
                            ...
                            <i
                              className={`fas ${
                                chevronVisibleArray[index] ? "fa-chevron-up" : "fa-chevron-down"
                              }`}
                            />
                          </button>
                                  ...
                                  >
                                    {itinerary.segments.map(
                                      ...
                                      (segment, segmentIndex) => {
                                        ...
                                        // const airlineNameD = `https://api.amadeus.com/v1/reference-data/locations?subType=AIRPORT&keyword=${iataCode}`;
                                                  ...
                                                  <div className="flight_det">
                                                    ...
                                                    {/* {Object.entries(countryNames).map(([iatadeparture, countryName]) => {
                                                          if (segment.departure.iataCode === iatadeparture) {
                                                            return (
                                                              <p key={iatadeparture}>
                                                        {countryName.split('/')[0]}     dsfdsaf cehck </p>
                                                            );
                                                          }
                                                          return null; 
                                                        })} */}
