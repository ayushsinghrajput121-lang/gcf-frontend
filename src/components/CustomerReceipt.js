    ...
    <>
      <div style={{ background: "#fff", border:'1px solid #000' }} className="container-fluid">
        <div className="tem-section">
            ...
            <table width="100%" cellPadding={0} cellSpacing={0}>
              <tbody>
                <tr>
                  ...
                  >
                    <b>Booking Reference #  {apiData?.randomNumber}</b>  <button className="print-button" onClick={handlePrint}>Print Receipt</button> <Link href="/" className="go-hm print-button" >Go To Home</Link>
          ...
          <div
            className="need mb-3"
            style={{ background: "#343f55", textAlign: "right" }}
          >
          ...
          <div sclass=" rounded h-100">
            <div
              ...
              style={{ background: "#343f55", textAlign: "left" }}
            >
